...
Après ce premier filtre, il reste `r nrow(result_dedupok)`. Néanmoins, on trouve encore des POI qui ne correspondent pas à ce que l'on cherche: des clubs, associations.  
